      ...
      >
          ...
          <div>
            ...
            <div className="space-y-4">
              {formData.options.map((option: string, index: number) => (
                <div
                  key={index}
                  className="flex items-start space-x-3 p-3 rounded-md bg-gray-700/50 border border-gray-700"
                >
                  <input
                    type="radio"
                    name="correctOption"
        ...
        <div className="col-span-4 flex flex-col space-y-4 h-full overflow-y-auto pl-2">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <textarea
              className="mt-1 block w-full flex-1 rounded-md border-gray-600 bg-gray-700 text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border p-2 font-mono placeholder-gray-400 resize-none"
